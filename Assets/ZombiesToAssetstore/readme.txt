...
run: normal run
refpose: the T-pose of the zombie, if you need it for some reason.
zombieRun: a more disjointed run
crouch: crouching
eat1-2: eating from the ground while crouching.

The lowpoly versions have the exact same animations, but LESS BONES! So they must use their own animations instead of the non-lowpoly zombie anims.
